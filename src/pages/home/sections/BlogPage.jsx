...
//     content: `Stay ahead of the curve with these emerging ceiling design trends...`,
//     author: "Michael Asamoah",
//     authorRole: "Lead Designer",
//     authorImage:
//       "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
...
//       <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white py-20 md:py-28 pt-28 md:pt-32 overflow-hidden">
...
//                 className="w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/30"
//               />
//               {searchQuery && (
//                 <button
...
// const PostCard = ({ post, onBookmark, onLike, isBookmarked, isLiked }) => {
//   const [imageLoaded, setImageLoaded] = useState(false);

//   return (
//     <article className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 group">
...
//           <button className="flex items-center gap-1 text-blue-600 font-semibold text-sm hover:gap-2 transition-all group/readmore">
//             Read More
...
//   return (
//     <article className="bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 group cursor-pointer">
...
//       <div className="container mx-auto px-4">
//         <div className="max-w-4xl mx-auto bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 rounded-3xl shadow-2xl overflow-hidden">
...
//                         className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/30"
//                         required
//                       />
//                     </div>
//                     <button
//                       type="submit"
//                       className="w-full bg-white text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-blue-50 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
//                     >
...
//               className="inline-flex items-center gap-3 bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
//             >
//               Start Your Project
...
//               <button
//                 key={topic}
//                 className="group p-6 bg-gray-50 hover:bg-blue-50 rounded-2xl text-left transition-all duration-300 hover:shadow-lg border border-gray-200 hover:border-blue-200"
//               >
...
//       setSubmitting(false);
//       // In a real app, you would update the post comments here
//     }, 1000);
//   };
...
//       {/* Enhanced Hero Section */}
//       <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white py-20 md:py-24 pt-28 md:pt-32 overflow-hidden">
//         <div className="absolute inset-0">
...
//           <button
//             onClick={() => (window.location.href = "/blog")}
//             className="inline-flex items-center gap-2 text-blue-100 hover:text-white mb-8 transition-colors group"
//           >
...
//                 <p className="text-blue-100 text-sm">{post.authorRole}</p>
//               </div>
//             </div>
...
//                   rows="6"
//                   className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none transition-all"
//                   required
//                 ></textarea>
//               </div>
...
//                   type="submit"
//                   disabled={submitting}
//                   className="bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-300 disabled:bg-blue-400 flex items-center gap-3 shadow-lg hover:shadow-xl min-w-40 justify-center"
//                 >
//                   {submitting ? (
//                     <>
...
//                       <span>{post.readTime}</span>
//                     </div>
//                     <button className="text-blue-600 font-semibold text-sm flex items-center gap-1 hover:gap-2 transition-all group/readmore">
//                       Read More
//                       <ArrowRight className="w-4 h-4 transition-transform group-hover/readmore:translate-x-1" />
//                     </button>
//                   </div>
...
//       <section className="relative bg-gradient-to-br from-gray-800 via-gray-700 to-gray-900 text-white py-12 md:py-16 pt-20 md:pt-24 overflow-hidden">
//         <div className="absolute inset-0">
...
//           ) : (
//             <>
//               {/* Featured Posts - Fixed overlapping issue */}
//               {filteredPosts.filter((post) => post.featured).length > 0 && (
//                 <div className="mb-12">
//                   <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
...
// // Featured Post Card Component - Fixed overlapping
// const FeaturedPostCard = ({
//   post,
//   onBookmark,
//   onLike,
...
//         <div className="lg:w-2/3 relative h-64 lg:h-auto min-h-[300px]">
//           {!imageLoaded && (
//             <div className="absolute inset-0 bg-gray-200 animate-pulse"></div>
//           )}
//           <img
