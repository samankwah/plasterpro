...
//                   <span
//                     className={`px-3 py-1 rounded-full text-xs font-semibold ${
//                       quickViewProduct.category === "Services"
//                         ? "bg-purple-100 text-purple-700"
//                         : quickViewProduct.category === "Hardware"
//                         ? "bg-blue-100 text-blue-700"
//                         : "bg-green-100 text-green-700"
//                     }`}
//                   >
...
//                 <button className="w-full mt-4 bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors font-medium shadow-sm">
...
//                     );
//                   }}
//                   className="w-full mt-4 bg-blue-600 text-white py-4 px-8 rounded-lg hover:bg-blue-700 transition-colors font-semibold shadow-sm text-lg"
//                 >
//                   Contact Us for Details
//                 </button>
//               </div>
