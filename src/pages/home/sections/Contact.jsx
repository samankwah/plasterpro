            ...
            {isSubmitted ? (
              ...
              <div className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-all flex items-center justify-center font-semibold shadow-lg hover:shadow-xl"
                >
                  <Send className="mr-2" size={20} />
                  Send Message
                </button>
